...
class AuthSignInErrorService {
  static getErrorMessage(
    ...
    switch (true) {
      case error.message.toLowerCase().includes('invalid login credentials'):
        return formatMessage({ id: 'error.auth.invalid' });
...
export default AuthSignInErrorService;
